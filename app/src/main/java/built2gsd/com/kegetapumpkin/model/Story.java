...
import built2gsd.com.kegetapumpkin.R;
...
public class Story {
    ...
    public Story(){
        ...
        mPages[4]=new Page(
                R.mipmap.page4,
                "You are riding the tractor and it stops two times, %1$s. Which one would you like to take?",
                new Choice("Go to the first stop", 5),
                new Choice("Go to the second stop", 7));
        ...
        mPages[7]=new Page(
                R.mipmap.page7,
                "You helped K and E find the right pumpkin, %1$s. K and E are happy with this one!",
                new Choice("Buy it", 8),
                new Choice("Go back to the tractor ride", 4));

        mPages[8]=new Page(
                R.mipmap.page8,
                "K and E hand over the pumpkin so that their parents can buy it. They are glad you came along. ",
